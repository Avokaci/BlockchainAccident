    ...
    <div id="Umstaende" class="col-md-8">
        ...
        <div class="row text-center">
            ...
            <div class="input-group">
                ...
                <input id="toggle-on3" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                <label for="toggle-off3">Fahrzeug B</label>
                <input id="toggle-off3" name="toggle" type="checkbox"></input>
                </div>             
            </div>
            <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on4" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off4">Fahrzeug B</label>
                    <input id="toggle-off4" name="toggle" type="checkbox"></input>
                </div>             
                </div>
            </div> 
            <div class="input-group">
                ...
                <input id="toggle-on5" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                <label for="toggle-off5">Fahrzeug B</label>
                <input id="toggle-off5" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on6" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off6">Fahrzeug B</label>
                    <input id="toggle-off6" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on7" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off7">Fahrzeug B</label>
                    <input id="toggle-off7" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on8" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off8">Fahrzeug B</label>
                    <input id="toggle-off8" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on9" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off9">Fahrzeug B</label>
                    <input id="toggle-off9" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on10" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off10">Fahrzeug B</label>
                    <input id="toggle-off10" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on11" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off11">Fahrzeug B</label>
                    <input id="toggle-off11" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on12" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off12">Fahrzeug B</label>
                    <input id="toggle-off12" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on13" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off13">Fahrzeug B</label>
                    <input id="toggle-off13" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on14" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off14">Fahrzeug B</label>
                    <input id="toggle-off14" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on15" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off15">Fahrzeug B</label>
                    <input id="toggle-off15" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on16" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off16">Fahrzeug B</label>
                    <input id="toggle-off16" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on17" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off17">Fahrzeug B</label>
                    <input id="toggle-off17" name="toggle" type="checkbox"></input>
                </div>             
                </div>
                </div>
                <div class="input-group">
                ...
                <div class ="col-sm">
                    ...
                    <input id="toggle-on18" name="toggle" type="checkbox"></input>
                </div>
                <div class ="col-sm">
                    <label for="toggle-off18">Fahrzeug B</label>
                    <input id="toggle-off18" name="toggle" type="checkbox"></input>
                </div>             
                </div>
            </div>
            </div>
