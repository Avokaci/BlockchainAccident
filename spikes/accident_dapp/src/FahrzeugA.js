...
class FahrzeugA extends Component {

  render() {
    return (
        <div id="FahrzeugA" class="col-md-8">
        <h4 id="section2" class="mb-3">FAHRZEUG A</h4>
...
<div class="row">
        ...
        <div class="row">
            ...
            <label for="dateofaccident">Klasse</label>
                <input type="text" id="klasse" class="form-control" required> </input>
            </div>
                <div class="col-md-6 mb-3">
